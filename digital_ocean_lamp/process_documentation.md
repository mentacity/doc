...
- Under repositories click the New button which is green
...
ssh-keygen
```
- ssh-keygen should set folder permissions for ~/.ssh correctly but for reference local .ssh folder permissions should be
```
chmod 700 .ssh
